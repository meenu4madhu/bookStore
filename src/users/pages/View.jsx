    ...
    <div className="shadow border p-5 shadow-gray-200">
      <div className="md:grid grid-cols-4 gap-x-10">
        ...
        <div className="col-span-1">
          <img  className='w-full' src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/contemporary-fiction-night-time-book-cover-design-template-1be47835c3058eb42211574e0c4ed8bf.webp?ts=1734004864" alt="book" />
           </div>
      ...
      <div className="bg-white rounded-2xl md:w-250 w-100">
        ...
        <div className="relative p-5">
          ...
          <div className="md:flex flex-wrap my-4">
            <img className='md:w-75 w-50 md:me-2 mb-2 md:mb-0' src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/contemporary-fiction-night-time-book-cover-design-template-1be47835c3058eb42211574e0c4ed8bf.webp?ts=1734004864" alt="book" />
            <img className='md:w-75 w-50 md:me-2 mb-2 md:mb-0' src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/contemporary-fiction-night-time-book-cover-design-template-1be47835c3058eb42211574e0c4ed8bf.webp?ts=1734004864" alt="book" />
            <img className='md:w-75 w-50 md:me-2 mb-2 md:mb-0' src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/contemporary-fiction-night-time-book-cover-design-template-1be47835c3058eb42211574e0c4ed8bf.webp?ts=1734004864" alt="book" />
          </div>
        </div>
